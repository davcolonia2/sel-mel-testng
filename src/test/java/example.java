...
public class example {
    ...
    // To make a test case runnable we need to provide annotation "@Test"
     @Test public void verifyLogoIsDisplayed() throws InterruptedException {
        ...
        // Verify that logo is displayed
         ...
         } else { System.out.println("LOGO Verification: FAILED");
         } driver.quit();
         ...
         // The expected value is usually in your - ticket/user story/requirements
        if(actualPageTitle.equals(expectedPageTitle)){ System.out.println("TITLE verification: PASSED");
